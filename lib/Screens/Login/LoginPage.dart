    ...
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            _buildSocialMediaAppButton(COLOR_GOOGLE, ImagemGoogle,
                48, enterAnimation.googleScaleTranslation.value),
            SizedBox(
              width: 8,
            ),
            _buildSocialMediaAppButton(COLOR_FACEBOOK, ImagemFacebook,
  ...
  Widget _buildTextHeader(Size size, TextTheme textTheme) {
    return Transform(
      ...
      child: Padding(
        ...
        child: HeaderText(text: TextoWelcome, imagePath: IMAGE_SLIPPER_PATH,),
      ),
    );
  }
}
